 ...
 */
public class WIMF_MessageListAdapter extends RecyclerView.Adapter<WIMF_MessageListAdapter.ViewHolder>{
    private static final String LOG_TAG = WIMF_MessageListAdapter.class.getSimpleName();
    ...
    /**
     * Create a new instance of {@link WIMF_MessageListAdapter}.
     ...
     */
    public WIMF_MessageListAdapter(Context context, ArrayList<WIMF_UserItems> itemList, LayoutInflater inflater, int resourceId)
    {
